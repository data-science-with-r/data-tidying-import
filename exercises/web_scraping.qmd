...
`html_text()` returns the raw underlying text, including any white spaces, HTML code, etc.
`html_text2()` tries to simulate how the text is displayed in the browser, i.e., cleans up the text.
