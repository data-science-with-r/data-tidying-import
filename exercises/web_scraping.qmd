...
toc: true
webr:
  packages: ['tidyverse', 'scales', 'rvest', 'polite']
filters:
  - webr
---
...
Both in the bottom right and in the red outline, you will see the element `section`. Click on a different title. You will again see the element `section`. We can use this information to pull the titles from the website using the following code:
